...
import { Bets, InputBetsPost } from '../protocols';
...
import { Participants } from '../protocols';

async function createBets(homeTeamScore: number, awayTeamScore: number, amountBet: number, gameId: number, participantId: number): Promise<Bets> {
